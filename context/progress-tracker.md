...
- Feature 02: Authentication (Clerk integration, route protection, user sync)
...
- Feature 02: Authentication — Clerk installation, `middleware.ts` route protection, user sync to database, replace placeholder auth forms with Clerk components
...
- Stack: Next.js 16.2.6, React 19.2.4, Tailwind CSS v4, TypeScript strict mode.
